...
public class EntityStore {
    ...
    public static void register(Entity entity) {
        if (!entity.isRegistered) {
            ...
            Debug.warning("Tried to add an entity (" + entity + ") to the store, but it's already in the store");
        }
    }
    ...
    public static void remove(Entity entity) {
        if (entity.isRegistered) {
            ...
            Debug.warning("Tried to remove an entity (" + entity + ") from the store, but it was not in the store");
        }
    }
     ...
     *
     * @param uuid UUID number to look for in the store
