...
public class SpriteSheet {
     ...
     *
     * @param image  BufferedImage that represents the entire strip
     * @param width  Width of each sprite/frame (same for all of them)
     * @param height Height of each sprite/frame (same for all of them)
     * @param rows   Number of rows, or "strips", of sprites that are in the strip
     * @param frames Number of frames in each row, or "strip" (same for entire strip)
     */
     ...
     *
     * @param image The BufferedImage to replace the strip with
     */
    ...
    private void loadAllSprites() {
        ...
        spriteCollection = new ArrayList<>(strips);
    ...
    /**
     * @param index Index of the sprite to get within the strip's sprite collection
